...
//Ventana flotante / Windows float
    showWelcome() {
        Swal.fire("Bienvenido", `Al juego de Tetris en JavaScript.
<br>
...
//JAMES RODRIGUEZ
    ...
    getRandomFigure() {
        /*
        * Tetromino names taken from / Nombres de los tetrominós tomados de: https://www.joe.co.uk/gaming/tetris-block-names-221127  
        * We return a new instance each time, because if we defined the figures in constants or variables, the same reference would be taken on some occasions / Regresamos una nueva instancia en cada ocasión, pues si definiéramos las figuras en constantes o variables, se tomaría la misma
         referencia en algunas ocasiones
        * */
        switch (Utils.getRandomNumberInRange(1, 7)) {
            case 1:
                /*
                The square (smashboy) /El cuadrado (smashboy)
            ...
            case 3:
                ...
                /*
                The L (orange ricky) / La L (orange ricky)
                  *
                ***
            ...
            case 4:
                ...
                /*
                The J (blue ricky) / La J (blue ricky)
                *
                ***
            ...
            case 5:
                /*
                The Z (Cleveland Z) / La Z (Cleveland Z)
               **
                **
               */
            ...
            case 6:
                ...
                /*
                The other Z (Rhode island Z) / La otra Z (Rhode island Z)
                **
               **
               */
                return new Tetromino([
    ...
    // Devuelve verdadero incluso si el punto no es válido (por ejemplo, si está fuera del límite, porque no es responsabilidad de la función)
    isEmptyPoint(x, y) {
